...
python trainModel.py models/bilstm_single.py logs/bilstm2iter17_hid$v/ embeddings/low_shuff_combine_tokenized.txt-iter17-min5.bin --value $v
python evaluateModel.py models/bilstm_single.py logs/bilstm2iter17_hid$v/ embeddings/low_shuff_combine_tokenized.txt-iter17-min5.bin --value $v
python evaluateModelF.py models/bilstm_single.py logs/bilstm2iter17_hid$v/ embeddings/low_shuff_combine_tokenized.txt-iter17-min5.bin --value $v
